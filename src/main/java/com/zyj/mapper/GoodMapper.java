...
*/
    ...
    //添加商品信息
   /* public void saveGood(String code,String name,String briefCode,int typeId,String supplierName,
                         String storeName,String ifGift,String ifReturn,Date registerDate,String imgUrl);*/
